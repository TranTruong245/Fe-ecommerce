...
//                         <button onClick={() => submitOTP()} className="btn btn-success px-4 verify-btn">
//                             Xác thực
//                         </button>
//                     </div>
//                 </div>
...
const Otp = (props) => {
    ...
    let submitOTP = async () => {
        const code =
            inputValues.so1 + inputValues.so2 + inputValues.so3 + inputValues.so4 + inputValues.so5 + inputValues.so6;
