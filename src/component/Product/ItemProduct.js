...
function ItemProduct(props) {
    return (
        <div className={props.type}>
            <div className="single-product" style={{ cursor: 'pointer', width: props.width, height: 'auto' }}>
                <Link to={`/detail-product/${props.id}`}>
                    ...
                    <div className="product-btm">
                        ...
                        <div className="mt-3 price-container">
                            <span className="discount-price">{CommonUtils.formatter.format(props.discountPrice)}</span>
                            <del>{CommonUtils.formatter.format(props.price)}</del>
                        </div>
                    </div>
                </Link>
